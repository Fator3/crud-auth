  ...
  <div style="position:relative;">
    <div>
      <component
        ...
        :custom-refresh-function="customRefreshFunction"
      ></component>
      <item-details
        :title="detailsTitle"
        :details-fields="detailsFields"
        v-on:customRefresh="customRefresh"
      ></item-details>
...
export default {
  ...
  methods: {
    ...
    ...mapMutations('crud', ['setPrefix', 'setPath', 'setPaths', 'setCreationMode']),
    ...
    customRefresh () {
      if (this.customRefreshFunction !== null) {
